export const translations = {
  vi: {
    ...
    spinnerAuspiciousNaming: 'Đang luận giải Ngũ hành, tìm kiếm vần điệu và ý nghĩa... Xin vui lòng chờ trong giây lát.',
    ...
    namingFormStep2Title: 'Bước 2: Thông Tin Cha Mẹ (Không bắt buộc)',
    namingFormStep3Title: 'Bước 3: Mong Muốn Về Tên Con',
    namingFormStep4Title: 'Bước 4: Yêu Cầu Khác (Không bắt buộc)',
    childLastNameLabel: 'Họ của con',
    childLastNamePlaceholder: 'Ví dụ: Nguyễn',
    childIsBornLabel: 'Con đã ra đời chưa?',
    optionYes: 'Rồi',
    optionNo: 'Chưa, đây là ngày dự sinh',
    fatherNameLabel: 'Họ và tên cha',
    fatherNamePlaceholder: 'Ví dụ: Nguyễn Văn An',
    motherNameLabel: 'Họ và tên mẹ',
    motherNamePlaceholder: 'Ví dụ: Trần Thị Bình',
    desiredQualitiesSubtitle: 'Chọn những phẩm chất, mong muốn bạn muốn gửi gắm vào tên của con (chọn 1 hoặc nhiều).',
    qualityIntelligent: 'Thông minh, Sáng suốt',
    ...
    otherConstraintsSubtitle: 'Bạn có yêu cầu đặc biệt nào về tên không?',
    otherConstraintsPlaceholder: 'Ví dụ: Tên lót phải là "Gia", tránh trùng tên ông bà, chỉ cần tên 3 chữ...',
    errorChildLastName: 'Vui lòng nhập họ của con.',
    errorDesiredQualities: 'Vui lòng chọn ít nhất một mong muốn.',
    namingFormSubmit: 'Nhận Gợi Ý Tên',
    namingResultTitle: 'Gợi Ý Tên Hợp Mệnh Cho Bé',
    namingResultAnalysisSummary: 'Phân Tích Tổng Quan',
    namingResultSuggestions: 'Các Gợi Ý Tên Gọi',
  ...
  en: {
    ...
    homeAuthUnavailable: 'Login and save features are currently unavailable.',
    ...
    spinnerAuspiciousNaming: 'Analyzing Five Elements, searching for rhythm and meaning... Please wait a moment.',
    ...
    namingFormStep2Title: 'Step 2: Parents\' Information (Optional)',
    namingFormStep3Title: 'Step 3: Desired Qualities in the Name',
    namingFormStep4Title: 'Step 4: Other Requirements (Optional)',
    childLastNameLabel: 'Child\'s Last Name',
    childLastNamePlaceholder: 'e.g., Smith',
    childIsBornLabel: 'Has the child been born yet?',
    optionYes: 'Yes',
    optionNo: 'No, this is the expected due date',
    fatherNameLabel: 'Father\'s Full Name',
    fatherNamePlaceholder: 'e.g., John Doe',
    motherNameLabel: 'Mother\'s Full Name',
    motherNamePlaceholder: 'e.g., Jane Doe',
    desiredQualitiesSubtitle: 'Select the qualities and wishes you want the name to embody (select one or more).',
    ...
    otherConstraintsSubtitle: 'Do you have any special requirements for the name?',
    otherConstraintsPlaceholder: 'e.g., The middle name must be "Anne", avoid grandparents\' names, only need a three-word name...',
    errorChildLastName: 'Please enter the child\'s last name.',
    errorDesiredQualities: 'Please select at least one desired quality.',
    namingFormSubmit: 'Get Name Suggestions',
    namingResultTitle: 'Auspicious Name Suggestions for Your Baby',
    namingResultAnalysisSummary: 'Overall Analysis',
