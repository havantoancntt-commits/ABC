export const translations = {
  ...
  en: {
    ...
    careerAdvisorDesc: 'Combines your astrological chart analysis with your interests and skills to provide personalized career suggestions.',
    careerAdvisorButton: 'Find My Career Path',
    careerAdvisorSubtitle: 'Discover a career path that aligns with both your destiny and who you are.',
    careerFormStep1Title: 'Step 1: Your Basic Information',
    careerFormStep2Title: 'Step 2: Your Passions & Interests',
    careerFormStep2Subtitle: 'Select the areas that make you feel most excited and energized (select one or more).',
    careerFormStep3Title: 'Step 3: Your Prominent Skills',
    careerFormStep3Subtitle: 'Select the skills you are most confident in or wish to develop (select one or more).',
    careerFormStep4Title: 'Step 4: Dreams & Aspirations',
    careerFormStep4Subtitle: 'Share your biggest goal or what you want to achieve in your career. This is optional but will help the AI provide more profound suggestions.',
    careerFormAspirationPlaceholder: 'e.g., I want to create products that benefit society, become a leading expert in my field, or achieve financial freedom...',
    ...
    careerResultTitle: 'Career Advisor Results',
