...
const Home: React.FC<Props> = (props) => {
    ...
    const features = [
        ...
        { title: t('fengShuiTitle'), description: t('fengShuiDesc'), buttonText: t('fengShuiButton'), onClick: props.onStartFengShui, buttonVariant: 'fengshui' as const, icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24"><path fill="#10b981" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><path fill="#34d399" d="M12.5 7v4.5H17v1h-4.5V17h-1v-4.5H7v-1h4.5V7h1z"/></svg> },
        ...
        { title: t('prayerGeneratorTitle'), description: t('prayerGeneratorDesc'), buttonText: t('prayerGeneratorButton'), onClick: props.onStartPrayerGenerator, buttonVariant: 'prayer' as const, icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24"><g fill="none" strokeWidth="1.5"><path stroke="#6ee7b7" d="M7.882 20.118a8 8 0 1010.236-10.236" opacity="0.7"/><path stroke="#34d399" d="M12.5 5.5a.5.5 0 100-1 .5.5 0 000 1zM15.5 8.5a.5.5 0 100-1 .5.5 0 000 1zM11.5 10.5a.5.5 0 100-1 .5.5 0 000 1zM8.5 12.5a.5.5 0 100-1 .5.5 0 000 1z"/><path stroke="#facc15" d="M18 18l-1.5-3-1.5 3h3zM15.25 15.25A5.002 5.002 0 007.5 10.5M4 20l3.5-3.5"/></g></svg> },
        ...
        { title: t('hoaTayTitle'), description: t('hoaTayDesc'), buttonText: t('hoaTayButton'), onClick: props.onStartHoaTay, buttonVariant: 'hoatay' as const, icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24"><path fill="#f472b6" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" opacity="0.4"/><path fill="#fecdd3" d="M12 17.6c-1.9 0-3.4-1.5-3.4-3.4 0-1.5 1-2.8 2.4-3.2.1-1.6.8-3 2-4 .4-.8 1.5-.8 2 0 1.2 1 1.8 2.4 2 4 .1.1.2.1.2.2 1.3.4 2.2 1.6 2.2 3 0 1.9-1.5 3.4-3.4 3.4h-1.6c-.1 0-.2 0-.2-.1z"/></svg> },
