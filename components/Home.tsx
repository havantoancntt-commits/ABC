...
const Home: React.FC<Props> = ({ onStartAstrology, onStartPhysiognomy, onStartZodiacFinder, onStartIChing, onStartShop, onStartNumerology, onStartPalmReading, onStartTarot, onStartFlowAstrology, onStartAuspiciousDayFinder, onStartHandwritingAnalysis, onStartCareerAdvisor, onStartTalismanGenerator, onStartAuspiciousNaming }) => {
    ...
    const features = [
        ...
        {
            title: t('auspiciousNamingTitle'), description: t('auspiciousNamingDesc'), buttonText: t('auspiciousNamingButton'),
            onClick: onStartAuspiciousNaming, buttonVariant: 'naming' as const,
        ...
        },
        {
            ...
            onClick: onStartPhysiognomy, buttonVariant: 'special' as const,
        ...
        },
        {
            ...
            onClick: onStartTarot, buttonVariant: 'tarot' as const,
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>
        },
        {
        ...
        },
        {
            ...
            onClick: onStartZodiacFinder, buttonVariant: 'secondary' as const,
        ...
        {
            title: t('shopTitle'), description: t('shopDesc'), buttonText: t('shopButton'),
            onClick: onStartShop, buttonVariant: 'shop' as const,
