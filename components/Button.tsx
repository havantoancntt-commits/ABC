...
type ButtonVariant = 'primary' | 'secondary' | 'danger' | 'special' | 'iching' | 'shop' | 'numerology' | 'palm' | 'tarot' | 'flow' | 'dayselection' | 'graphology' | 'career' | 'talisman' | 'naming' | 'bioenergy' | 'fortune' | 'wealth' | 'prayer' | 'fengshui' | 'hoatay' | 'nhatmenh';
...
const Button: React.FC<Props> = ({
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    ...
    nhatmenh: 'bg-gradient-to-br from-purple-600 via-blue-500 to-cyan-400 text-white hover:brightness-110 focus-visible:ring-purple-400 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40',
  };
