        ...
        <div className="max-w-7xl mx-auto">
            ...
            <Card className="mt-12">
                <div className="text-center mb-10">
                    <h3 className="text-3xl font-bold font-serif text-yellow-300">{t('flowAstrologyTalismanTitle')}</h3>
                    <p className="text-gray-400 mt-2 max-w-xl mx-auto">{data.talisman.description}</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="flex flex-col items-center">
                        <div className="w-full max-w-[200px] mx-auto p-4 bg-gray-950 rounded-2xl border border-yellow-500/30 shadow-lg">
                            <div
                     ...
                     <div className="space-y-4">
                        <div>
                            <p className="font-serif text-xl text-yellow-200/90 tracking-widest text-center md:text-left drop-shadow-[0_1px_2px_rgba(250,204,21,0.5)]">"{data.talisman.cauChu}"</p>
                        </div>
                        <div>
                            <h4 className="font-semibold text-amber-300">{t('talismanInterpretation')}</h4>
                            <p className="text-gray-400 text-sm mt-1 whitespace-pre-wrap">{data.talisman.interpretation}</p>
                        </div>
                        <div>
                            <h4 className="font-semibold text-amber-300">{t('talismanUsage')}</h4>
                            <p className="text-gray-400 text-sm mt-1 whitespace-pre-wrap">{data.talisman.usage}</p>
                        </div>
                    </div>
                </div>
            </Card>
