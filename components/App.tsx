          ...
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-gray-900/40 p-4 rounded-lg border border-gray-700/50 text-left md:text-right">
              ...
              <div className="flex items-center flex-wrap gap-3 mt-3 md:justify-end">
                ...
                <a
                  href="https://vt.tiktok.com/ZSHtp8VBv97Sw-X46jh/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold py-2 px-4 rounded-lg hover:from-pink-600 hover:to-red-600 transition-colors shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                >
